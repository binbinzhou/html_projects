window.onload = function(){
	new AutoPlay("imgshow");
	var global = document.getElementById("global");
	var lanuages = document.getElementById("lanuages");
	var searchs = document.getElementById("searchs");
	var form = document.getElementById("form");
				
	global.onclick = function(){		
		if(lanuages.style.display == "block"){
			lanuages.style.display = "none";
		} else{
				lanuages.style.display = "block";
		};
	};
